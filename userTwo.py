class UserTwo():
    ...
    def backCard(self, canvas):
        ...
        canvas.create_text(1380,145, text=f'1: {firstScore}', fill='black',
                           font = 'Times 17 bold')
        secondScore = self.pickingCard['2']
        canvas.create_text(1380,175, text=f'2: {secondScore}', fill='black',
                           font = 'Times 17 bold')
        thirdScore = self.pickingCard['3']
        canvas.create_text(1380,205, text=f'3: {thirdScore}', fill='black',
                           font = 'Times 17 bold')
        fourthScore = self.pickingCard['4']
        canvas.create_text(1380,235, text=f'4: {fourthScore}', fill='black',
                           font = 'Times 17 bold')
        fifthScore = self.pickingCard['5']
        canvas.create_text(1380,265, text=f'5: {fifthScore}', fill='black',
                           font = 'Times 17 bold')
        sixthScore = self.pickingCard['6']
        canvas.create_text(1380,295, text=f'6: {sixthScore}', fill='black',
                           font = 'Times 17 bold')
        seventhScore = self.pickingCard['7']
        canvas.create_text(1380,325, text=f'7: {seventhScore}', fill='black',
                           font = 'Times 17 bold')
        canvas.create_line(1425,105,1425,345, fill='black')
        canvas.create_text(1465,120, text='Placing', fill='black',
                           font = 'Times 13 bold underline')
        firstPlacing = self.placingCard['1']
        canvas.create_text(1465,170, text=f'1: {firstPlacing}', fill='black',
                           font = 'Times 20 bold')
        secondPlacing = self.placingCard['2']
        canvas.create_text(1465,220, text=f'2: {secondPlacing}', fill='black',
                           font = 'Times 20 bold')
        thirdPlacing = self.placingCard['3']
        canvas.create_text(1465,270, text=f'3: {thirdPlacing}', fill='black',
                           font = 'Times 20 bold')
        fourthPlacing = self.placingCard['4']
        canvas.create_text(1465,320, text=f'4: {fourthPlacing}', fill='black',
                           font = 'Times 20 bold')

    def currentRocks(self, canvas):
        canvas.create_text(1140,410, text='Your Current\n Rocks', fill='purple',
                           font = 'Helvetica 16 bold italic')
        canvas.create_oval(1100-self.r, 480-self.r, 1100+self.r, 480+self.r, 
                           fill='blue',outline='blue')
        canvas.create_text(1160, 480, text = f' : {self.blue}',fill='black',
                           font = 'Helvetica 25')
        canvas.create_oval(1100-self.r, 550-self.r, 1100+self.r, 550+self.r, 
                           fill='red', outline='red')
        canvas.create_text(1160, 550, text = f' : {self.red}',fill='black',
                           font = 'Helvetica 25')
        canvas.create_oval(1100-self.r, 620-self.r, 1100+self.r, 620+self.r, 
                           fill='green', outline='green')
        canvas.create_text(1160, 620, text = f' : {self.green}',fill='black',
                           font = 'Helvetica 25')
        canvas.create_oval(1100-self.r, 690-self.r, 1100+self.r, 690+self.r, 
                           fill='pink', outline='pink')
        canvas.create_text(1160, 690, text = f' : {self.pink}',fill='black',
                           font = 'Helvetica 25')